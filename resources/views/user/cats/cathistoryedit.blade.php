        ...
        <div class="form-group row">
          ...
          <div class="col-md-10">
            @if ($cat_form->image_path)
                      <div class="mb-3">
                          <img src="{{ $cat_form->image_path }}" class="img-fluid rounded">
              <div class="form-check mt-2">
                <input type="checkbox" class="form-check-input" id="removeImage" name="remove" value="true">
                <label class="form-check-label" for="removeImage">登録済み画像を削除する</label>
              </div>
            </div>
            @endif
